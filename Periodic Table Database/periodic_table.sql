...
--
-- Name: properties foreign_key_types; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT foreign_key_types FOREIGN KEY (type_id) REFERENCES public.types(type_id);
